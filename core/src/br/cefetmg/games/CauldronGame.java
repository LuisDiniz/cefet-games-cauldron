...
public class CauldronGame extends ApplicationAdapter {
    ...
    public void create() {
        ...
        assets.load("pocaoRealeza.pfx", ParticleEffect.class, loadParam);
    ...
    private void aoTerminoDoCarregamento() {
        ...
        fogo = ((ParticleEffect) assets.get("pocaoRealeza.pfx")).copy();
        fogo.init();
        fogo.start();
        fogo.translate(new Vector3(0, 0.1f, 0));
        sistemaParticulas.add(fogo);

        // instancia, configura e dá início ao efeito de bolhas
